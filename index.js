...
async function scaffoldServer(projectName) {
  ...
  fs.renameSync(path.join(clientDir, '_env.production'), path.join(clientDir, '.env.production'));
  fs.renameSync(path.join(clientDir, '_eslintrc'), path.join(clientDir, '.eslintrc'));
  fs.renameSync(path.join(clientDir, '_gitignore'), path.join(clientDir, '.gitignore'));
...
async function scaffoldClient(projectName) {
  ...
  fs.renameSync(path.join(projectDir, '_env.staging'), path.join(projectDir, '.env.staging'));
  fs.renameSync(path.join(projectDir, '_env.production'), path.join(projectDir, '.env.production'));
  fs.renameSync(path.join(projectDir, '_eslintrc'), path.join(projectDir, '.eslintrc'));
...
if (answers.type === "no") {
  ...
  console.log("");
  console.log(chalk.yellow.bold(`React project scaffolded in '/${projectName}'`));
  console.log('-------------------------');
...
if (answers.type === "yes") {
  ...
  console.log("");
  console.log(chalk.yellow.bold(`Fullstack project scaffolded in '/${projectName}'`));
  console.log('-------------------------');
  console.log(` To get started, run:`);
  console.log(chalk.italic(`  > cd ${projectName}`));
  console.log(chalk.italic(`  > npm install`));
